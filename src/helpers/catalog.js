...
import { catActiveSelect, changeCatalog, productsSelect } from "../store/productsSlice";
...
export default function CatalogProducts(){
  ...
  return(
    <div className="dropdown">
      <img src={categoryLogo} onClick={()=> dispatch(changeCatalog(!catActive))} style={{width:100+'px'}} alt='categoryLogo'/>
